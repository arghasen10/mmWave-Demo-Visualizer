...
(function()
{
    ...
    ICommInterface.prototype.read = function(u2a, registerInfo)
    {
    };
    
    ICommInterface.prototype.write = function(u2a, registerInfo)
    {
    };
    ...
    var I2C_Interface = function(settings, registerModel) 
    {
    ...
    I2C_Interface.prototype.read = function(u2a, info)
    {
        ...
        this.readData[3] = info.nBytes !== undefined ? info.nBytes : Math.ceil(info.size !== undefined ? info.size/8 : 1);
    ...
    I2C_Interface.prototype.multiRegisterRead = function(u2a, startRegisterInfo, count)
    {
        setDeviceAddress(this._registerModel, this.readData, startRegisterInfo);
    ...
    I2C_Interface.prototype.write = function(u2a, info, value)
    {
        ...
        setDeviceAddress(this._registerModel, this.writeData, info);
    ...
    GPIO_Interface.prototype.read = function(u2a, info) 
    {
        return u2a.readResponse(u2a.sendCommandPacket(Command.Cmd_GPIO_ReadPort, [this._pin])).then(getResult);
    };

    GPIO_Interface.prototype.write = function(u2a, info, value)
    {
    ...
    UART_Interface.prototype.read = function(u2a, info)
    {
        var that = this;
        return this.uartCodec.readValue(info).then(function(data) 
        {
    ...
    UART_Interface.prototype.write = function(u2a, info, value)
    {
        return this.uartCodec.writeValue(info, value);
    };
    ...
    {
        var clockPhaseMap = { "first": 0, "following": 1 };
        var clockPolarityMap = { "low": 0, "high": 1 };
        var bitDirectionMap = { "lsb": 0, "msb": 1 };
        var latchTypeMap = { "word": 0, "packet": 1 };
    ...
    SPI_Interface.prototype.read = function(u2a, info)
    {
    ...
    SPI_Interface.prototype.write = function(u2a, info, value)
    {
    ...
    UnknownCommInterface.prototype.read = function(u2a, info)
    {
    ...
    USB2ANY.prototype.connect = function(settings)
    {
                ...
                if (interfaces)
                {
                    for(var j = 0; j < interfaces.length; j++)
                    {
                        ...
                        { 
                            ...
                            {
                                case 'power':
                                    commInterface = new Power_Interface(interfaceSettings, config._registerModel);
                                    break;
                                case 'i2c':
                                    that._comm = config._comm = commInterface = new I2C_Interface(interfaceSettings, config._registerModel);
                                    break;
                                case 'spi':
                                    that._comm = config._comm = commInterface = new SPI_Interface(interfaceSettings, config._registerModel);
                                    break;
                                case 'gpio':
                                    commInterface = new GPIO_Interface(interfaceSettings, config._registerModel);
                                    break;
                                case 'uart':
                                    that.uartInterface = that._comm = config._comm = commInterface = new UART_Interface(interfaceSettings, config._registerModel);
                                    break;
                                default:
        ...
        }).timeout(250, "No response from USB2ANY controller.");
    };
    ...
    USB2ANY.prototype.readValue = function(registerInfo, registerModel)
    {
        var _comm = registerInfo.comm || (registerModel && registerModel._comm) || this._comm;
        if (_comm !== null) 
        {
            return _comm.read(this, registerInfo);
        } 
        else 
        {
    ...
    USB2ANY.prototype.multiRegisterRead = function(startRegisterInfo, count, registerModel)
    {
        ...
        if (_comm !== null) 
        {
            ...
            {
                return _comm.multiRegisterRead(this, startRegisterInfo, count);
            }
            else
            {
                return this.doMultiRegisterRead(startRegisterInfo, count, registerModel);
            }
        }
        else 
        {
    ...
    USB2ANY.prototype.writeValue = function(registerInfo, value, registerModel)
    {
        var _comm = registerInfo.comm || (registerModel && registerModel._comm) || this._comm;
        if (_comm !== null) 
        {
            ...
            return _comm.write(this, registerInfo, value);
        } 
        else 
        {
    ...
    USB2ANY.prototype.decode = function(target, rawData)
    {
        ...
        {
            gc.console.log('USB2ANY', 'USB2ANY error: ' + e);
            return false;
        }
    };
    ...
    USB2ANY.prototype.isConnected = function()
    {
        return gc.databind.AbstractMessageBasedCodec.prototype.isConnected.call(this).then(pingController.bind(this));
    };
